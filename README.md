...
**Single JS file: approximately 281 KB, or 86 KB with gzip.** No runtime dependencies, WebAssembly or Java installation required.
...
npm package: [`@jar-analyzer/jsd`](https://www.npmjs.com/package/@jar-analyzer/jsd), published version **1.2.0**.
...
| Unit                 |   340 | Node.js 24          |
| Round-trip: debug    |   183 | JDK 8/11/17/21/25   |
| Round-trip: no debug |   183 | JDK 8/17/25         |
