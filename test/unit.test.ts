...
import './discard.test.js';
import './demo-workspace.test.js';
import './demo-files.test.js';
import './demo-archives.test.js';
import './limits.test.js';
import './java-types.test.js';
import './flow.test.js';
import './printer-readonly.test.js';
import './recognition.test.js';
import './bytecode-edge.test.js';
import './demo.test.js';
import './locals.test.js';
...
import { assertGeneratedSources } from './roundtrip-checks.mjs';
