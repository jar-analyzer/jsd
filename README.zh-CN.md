...
**单个 ESM 文件约 252 KB，gzip 后约 77 KB。** 无运行时依赖，无需 WebAssembly 或 Java 环境。
...
| 单元测试  | 311 个引擎与 Demo 用例                                | Node.js 24                                   |
| Java 往返 | 149 个用例，覆盖求值顺序、控制流、异常和资源管理      | JDK 8、11、17、21、25；无调试信息：8、17、25 |
| 现代 Java | 最多 15 个 Java 9–25 用例，覆盖有、无调试信息两种模式 | JDK 21、25                                   |
